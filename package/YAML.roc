...
YAML := { fieldNameMapping : FieldNameMapping, skipMissingProperties : Bool, nullDecodeAsEmpty : Bool }
    implements [
        DecoderFormatting {
            u8: decodeU8,
            u16: decodeU16,
...
utf8 = @YAML { fieldNameMapping: Default, skipMissingProperties: Bool.true, nullDecodeAsEmpty: Bool.true }

utf8With : { fieldNameMapping ? FieldNameMapping, skipMissingProperties ? Bool, nullDecodeAsEmpty ? Bool } -> YAML
utf8With = \{ fieldNameMapping ? Default, skipMissingProperties ? Bool.true, nullDecodeAsEmpty ? Bool.true } ->
    @YAML { fieldNameMapping, skipMissingProperties, nullDecodeAsEmpty }

## Mapping between Roc record fields and YAML object names
FieldNameMapping : [
...
decodeU8 = Decode.custom \bytes, @YAML {} ->
...
decodeU16 = Decode.custom \bytes, @YAML {} ->
    { taken, rest } = takeJsonNumber bytes
...
decodeU32 = Decode.custom \bytes, @YAML {} ->
    { taken, rest } = takeJsonNumber bytes
...
decodeU64 = Decode.custom \bytes, @YAML {} ->
    { taken, rest } = takeJsonNumber bytes
...
decodeU128 = Decode.custom \bytes, @YAML {} ->
    { taken, rest } = takeJsonNumber bytes
...
decodeI8 = Decode.custom \bytes, @YAML {} ->
    { taken, rest } = takeJsonNumber bytes
...
decodeI16 = Decode.custom \bytes, @YAML {} ->
    { taken, rest } = takeJsonNumber bytes
...
decodeI32 = Decode.custom \bytes, @YAML {} ->
    { taken, rest } = takeJsonNumber bytes
...
decodeI64 = Decode.custom \bytes, @YAML {} ->
    { taken, rest } = takeJsonNumber bytes
...
decodeI128 = Decode.custom \bytes, @YAML {} ->
    { taken, rest } = takeJsonNumber bytes
...
decodeF32 = Decode.custom \bytes, @YAML {} ->
    { taken, rest } = takeJsonNumber bytes
...
decodeF64 = Decode.custom \bytes, @YAML {} ->
    { taken, rest } = takeJsonNumber bytes
...
decodeDec = Decode.custom \bytes, @YAML {} ->
    { taken, rest } = takeJsonNumber bytes
...
decodeBool = Decode.custom \bytes, @YAML {} ->
    when bytes is
...
decodeString = Decode.custom \bytes, @YAML {} ->
...
decodeRecord = \initialState, stepField, finalizer -> Decode.custom \bytes, @YAML { fieldNameMapping, skipMissingProperties, nullDecodeAsEmpty } ->
                        ...
                        (
                            ...
                            when (stepField recordState fieldName, skipMissingProperties) is
                                ...
                                (Keep valueDecoder, _) ->
                                    ...
                                    decodePotentialNull valueBytes valueDecoder (@YAML { fieldNameMapping, skipMissingProperties, nullDecodeAsEmpty })
                        )
                        |> tryDecode
...
decodePotentialNull = \bytes, decoder, @YAML jsonFmt ->
    when nullToEmpty bytes jsonFmt.nullDecodeAsEmpty is
        Null { bytes: nullBytes, rest: nullRest } ->
            decode = Decode.decodeWith (nullBytes) decoder (@YAML jsonFmt)
        ...
        NotNull ->
            Decode.decodeWith bytes decoder (@YAML jsonFmt)
